 ...
 *
 */
@Getter @Setter public class RelayUnsidelinedMessageTask extends BaseRelayMessageTask {

    public RelayUnsidelinedMessageTask(Serializable TaskId, String groupId, String messageId,
