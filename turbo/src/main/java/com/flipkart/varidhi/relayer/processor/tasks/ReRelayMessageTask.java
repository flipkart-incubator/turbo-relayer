...
@Getter @Setter
public class ReRelayMessageTask extends RelayMessageTask {
    Long appSequenceId;
    public ReRelayMessageTask(Serializable taskId, Long appSequenceId, String groupId, String messageId, String messageData, String exchangeName,
                              String exchangeType, String httpMethod, String httpUri, String customHeaders, String replyTo,
        ...
        super(taskId, appSequenceId ,groupId, messageId, messageData, exchangeName, exchangeType, httpMethod,
