 ...
 *
 */
public class SubProcessorJob implements Runnable {
    ProcessorTaskExecutor processorTaskExecutor;
    ProcessorTask processorTask;

    public SubProcessorJob(ProcessorTaskExecutor processorTaskExecutor,
        ProcessorTask processorTask) {
        this.processorTaskExecutor = processorTaskExecutor;
        this.processorTask = processorTask;
    }

    @Override public void run() {
        processorTaskExecutor.execute(processorTask);
    }
}
