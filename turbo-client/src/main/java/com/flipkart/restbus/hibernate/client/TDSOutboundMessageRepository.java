...
public interface TDSOutboundMessageRepository {

    TDSMetaDataEntity persist(OutboundMessage message);

    List<TDSMetaDataEntity> persist(List<? extends OutboundMessage> messages);

    List<TDSMetaDataEntity> persist(String dbShard, List<? extends OutboundMessage> messages) throws ConfigurationException;

    OutboundMessage findMessageById(String messageId, String tableName);
}
